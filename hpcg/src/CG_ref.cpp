...
//#endif
  ...
  for (int k=1; k<=max_iter && normr/normr0 > tolerance; k++ ) {
    // printf("doPreconditioning = %d\n", doPreconditioning);
    // printf("Ref CG Iteration %d\n", k);
    // printf("normr = %f\n", normr);
    // printf("normr0 = %f\n", normr0);
    // printf("normr/normr0 = %f\n", normr/normr0);
    TICK();
...
//#endif
  ...
  //printf("Ref took %d iterations and reach norm normr/normr0 = %e doPreconditioning=%d\n", niters, normr/normr0, doPreconditioning);
  return 0;
}
