...
public:
    ...
    std::string version_name = "Banded explicit Shared Memory (rows_per_SM pow2 1024 threads 2x physical cores)";
    std::string additional_parameters = "align number of rows per SM with the number of threads per block";
