...
void no_store_striped_coloring_Implementation<T>::no_store_striped_coloring_computeSymGS(
    ...
    // CHECK_CUDA(hipMemcpy(&looki_1082, &x_d[1082], sizeof(DataType), hipMemcpyDeviceToHost));
    ...
    // CHECK_CUDA(hipMemcpy(&looki_1082, &x_d[1082], sizeof(double), hipMemcpyDeviceToHost));
