...
int main() {
    ...
    run_cuSparse_3d27p__benchmarks(8, 8, 8, folder_path);
    run_cuSparse_3d27p__benchmarks(16, 16, 16, folder_path);
    run_cuSparse_3d27p__benchmarks(32, 32, 32, folder_path);
